...
//         onPressed: () {
//           // You need to create a PropertyModel or pass the required data here
//           // For now, let's create a dummy PropertyModel or use the latest values from the form
...
//   void _updatePostData(PropertyModel property) {
//     // 1. Update PostData (if you still need it for temporary storage)
//     ref
...
//     // 2. Also create a PropertyModel and push it into productProvider
...
//       uploaderPhoneNumber: 123456789,
//       insideViews: [],
//       thumbnail: _thumbnailPhoto?.path ?? "", // ✅ FIXED
//       discount: (discount ?? 0).toDouble(),
//       destinationTitle: _propertyType,
//     );
...
//     // 3. Navigate back or show a success message
